...
export default function DashboardPage() {
    ...
    return (
		<div className="grid grid-rows-12 grid-cols-1 md:grid-cols-4 md:gap-4 w-full h-full">
          {/* Sidebar */}
          <div className={`${isFeedsExpanded ? 'row-start-1 row-end-5' : 'row-start-1 row-end-2'} md:col-span-1 md:row-span-12 order-1 md:order-2 flex flex-col md:items-end gap-4 bg-black/50 border-b md:border-b-none md:border-l overflow-y-scroll`}>
